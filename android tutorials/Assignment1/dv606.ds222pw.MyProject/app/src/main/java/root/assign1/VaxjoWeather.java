...
public class VaxjoWeather extends AppCompatActivity {
    ...
    private WeatherForecast forecast1 = null;
    private String[] report_list = new String[]{"Cloudy", "Sunny"};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /*You should implement an Adapter for WeatherForecasts. Then your code should be able to retrieve data
        as a WeatherReport, create an instance of the Adapter and assign in to a ListView, and add all of
        WeatherForecasts (nested in WeatherReport) to this Adapter. */

        ListView listView = (ListView) findViewById(R.id.weather_list);
        adapter2 = new WeatherAdapter(this, R.layout.forecast_list_item, weather_Array1, weather_Array2,weather_Array3, weather_Array4);
    ...
    public class WeatherAdapter extends ArrayAdapter<String> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            View rowView = inflater.inflate(R.layout.forecast_list_item, parent, false);
            ...
            } else if (s.toLowerCase().contains("sol") || s.toLowerCase().contains("klarvær")) {
