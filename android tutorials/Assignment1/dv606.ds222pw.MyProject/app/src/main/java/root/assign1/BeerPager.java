...
public class BeerPager extends AppCompatActivity {
    ...
    private int[] imageArray = {
            R.drawable.morning_delight,R.drawable.good_morning,R.drawable.pliny_the_younger,
            R.drawable.heady_topper,R.drawable.kentucky_brunch_brand_stout,
            R.drawable.russian_river_pliny_the_elder, R.drawable.norrlands
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imageView = (ImageView) findViewById(R.id.beer_icon);
        System.out.println("imageview output " + findViewById(R.id.beer_icon));
        ...
        private class MyPagerAdapter extends FragmentPagerAdapter {
            ...
            public MyPagerAdapter(FragmentManager fm) {
                ...
                fragments[0] = BeerFragment.create("Beer 1 out of " + getCount(),imageArray[0], description[0]);
                //imageView.setImageResource(R.drawable.morning_delight);
                fragments[1] = BeerFragment.create("Beer 2 out of " + getCount(),imageArray[1], description[1]);
                //imageView.setImageResource(R.drawable.good_morning);
                fragments[2] = BeerFragment.create("Beer 3 out of " + getCount(),imageArray[2], description[2]);
                //imageView.setImageResource(R.drawable.pliny_the_younger);
                fragments[3] = BeerFragment.create("Beer 4 out of " + getCount(),imageArray[3], description[3]);
               // imageView.setImageResource(R.drawable.heady_topper);
                fragments[4] = BeerFragment.create("Beer 5 out of " + getCount(),imageArray[4], description[4]);
               // imageView.setImageResource(R.drawable.kentucky_brunch_brand_stout);
                fragments[5] = BeerFragment.create("Beer 6 out of " + getCount(),imageArray[5], description[5]);
               // imageView.setImageResource(R.drawable.russian_river_pliny_the_elder);
                fragments[6] = BeerFragment.create("Beer 7 out of " + getCount(),imageArray[6], description[6]);
               // imageView.setImageResource(R.drawable.norrlands);
