...
import grace.assignment3.CityMap.CityMap;
import grace.assignment3.RoadMap.RoadMap;
import grace.assignment3.WeatherApp.VaxjoWeather;
import grace.assignment3.CallHistory.CallLog;
...
public class MainList extends ListActivity {
    ...
    private void setup_activities() {
        ...
        addActivity("CallLog", CallLog.class);
        addActivity("City Map", CityMap.class);
        addActivity("Road map", RoadMap.class);
    }
