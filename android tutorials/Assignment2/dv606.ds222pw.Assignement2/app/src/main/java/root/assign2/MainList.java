...
import root.assign2.alarmClock.Alarm_Clock;
import root.assign2.mp3Player.MP3Player;
import root.assign2.myCountries.MyCountries;
...
public class MainList extends ListActivity {
    ...
    private void setup_activities() {
        ...
        addActivity("Calendar", MyCountries.class);
        addActivity("AlarmClock", Alarm_Clock.class);
