...
--data '{"name":"David","gender":"Male","movieGenres":[{"id":null,"name":"Comedy","users":null}]}' 'http://localhost:8080/user/1'
...
curl --verbose --header "Content-Type: application/json" --request PUT --data '{"name":"David1","gender":"Male","movieGenres":[{"id":null,"name":"Comedy","users":null}]}' 'http://localhost:8080/user/2'
...
curl --verbose --header "Content-Type: application/json" --request PUT --data '{"name":"David3","gender":"Male","movieGenres":[{"id":null,"name":"Comedy","users":null}]}' 'http://localhost:8080/user/3'
...
curl --verbose --header "Content-Type: application/json" --request PUT --data '{"name":"John","gender":"Male","movieGenres":[{"id":null,"name":"Comedy","users":null}]}' 'http://localhost:8080/user/4'

curl --verbose --header "Content-Type: application/json" --request POST --data '{"email":"e","password":"e"}' 'http://localhost:8080/account'
curl --verbose --header "Content-Type: application/json" --request PUT --data '{"name":"Missy","gender":"Female","movieGenres":[{"id":null,"name":"Comedy","users":null}]}' 'http://localhost:8080/user/5'
