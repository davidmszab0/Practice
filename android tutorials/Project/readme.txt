...
$ docker run --name friendfinder -p 3306:3306 -e MYSQL_ALLOW_EMPTY_PASSWORD=yes -v /Users/grace/git/github/Practice/android\ tutorials/Project/mysql_persistent:/var/lib/mysql -d mysql
